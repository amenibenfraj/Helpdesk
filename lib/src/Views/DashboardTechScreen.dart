...
class DashboardTechController extends GetxController {
  ...
  Future<void> loadStats() async {
    ticketController.TicketTech.clear();
    await ticketController.loadTicketsByTechnician();
    
    allTickets = ticketController.TicketTech.length;
    inProgressTickets = ticketController.TicketTech
        .where((t) => t.status == "In Progress")
        .length;
    resolvedTickets = ticketController.TicketTech
        .where((t) => t.status == "Resolved")
        .length;
    closedTickets = ticketController.TicketTech
  ...
  Future<List<Ticket>> getRecentTickets() async {
    return ticketController.TicketTech
        .where((ticket) => ticket.technicienId != null)
        .toList()
        .reversed
        .take(3)
        .toList();
...
class DashboardTechScreen extends StatefulWidget {
  const DashboardTechScreen({super.key});

  @override
  State createState() => _DashboardTechScreenState();
}

class _DashboardTechScreenState extends State<DashboardTechScreen> {
  ...
  final dashboardController = Get.put(DashboardTechController());
  final TicketController ticketController = Get.find<TicketController>();
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: GetBuilder<DashboardTechController>(
                          builder: (controller) {
                            return Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
  ...
  Widget _buildStatsCards(DashboardTechController controller) {
  ...
  Widget _buildTicketStatusOverview(DashboardTechController controller) {
      ...
      child: Column(
        ...
        children: [
          ...
          Obx(() {
            ...
            if (ticketController.TicketTech.isEmpty) {
              return const Center(
                child: Padding(
            ...
            // Show recent assigned tickets
            return FutureBuilder<List<Ticket>>(
              future: dashboardController.getRecentTickets(),
